...
const styles: Record<string, React.CSSProperties> = {
  header:       { display: 'flex', alignItems: 'center', gap: '.75rem', marginBottom: '1.25rem' },
  h2:           { margin: 0, fontSize: '1.25rem', fontWeight: 700 },
  btnRefresh:   { padding: '.25rem .6rem', background: '#f3f4f6', border: '1px solid #d1d5db', borderRadius: 4, fontSize: '.8rem', cursor: 'pointer' },
  tabBar:       { display: 'flex', gap: 0, borderBottom: '2px solid #e5e7eb', marginBottom: 0 },
  tab:          { padding: '.5rem 1.1rem', background: 'none', border: 'none', borderBottom: '2px solid transparent', marginBottom: -2, fontSize: '.875rem', color: '#6b7280', cursor: 'pointer', fontWeight: 500 },
  tabActive:    { padding: '.5rem 1.1rem', background: 'none', border: 'none', borderBottom: '2px solid #2563eb', marginBottom: -2, fontSize: '.875rem', color: '#2563eb', cursor: 'pointer', fontWeight: 600 },
  tabCount:     { marginLeft: '.4rem', background: '#f3f4f6', color: '#6b7280', padding: '1px 6px', borderRadius: 10, fontSize: '.7rem', fontWeight: 600 },
  tabCountActive: { marginLeft: '.4rem', background: '#dbeafe', color: '#1e40af', padding: '1px 6px', borderRadius: 10, fontSize: '.7rem', fontWeight: 600 },
  panel:        { border: '1px solid #e5e7eb', borderTop: 'none', borderRadius: '0 0 6px 6px', overflow: 'hidden' },
  selectAllRow: { display: 'flex', alignItems: 'center', gap: '1rem', padding: '.45rem .85rem', background: '#f9fafb', borderBottom: '1px solid #e5e7eb' },
  checkLabel:   { display: 'flex', alignItems: 'center', gap: '.4rem', fontSize: '.8rem', cursor: 'pointer' },
  selCount:     { fontSize: '.75rem', color: '#9ca3af', marginLeft: 'auto' },
  table:        { width: '100%', borderCollapse: 'collapse' },
  th:           { textAlign: 'left', padding: '.45rem .75rem', background: '#f9fafb', borderBottom: '1px solid #e5e7eb', fontSize: '.72rem', fontWeight: 600, color: '#6b7280', textTransform: 'uppercase' as const },
  tr:           { borderBottom: '1px solid #f3f4f6' },
  domainBorder: { borderTop: '2px solid #e5e7eb' },
  td:           { padding: '.45rem .75rem', fontSize: '.8rem', verticalAlign: 'middle' },
  tdCheck:      { padding: '.45rem .75rem', width: 28, verticalAlign: 'middle' },
  ...
  footer:       { marginTop: '1.25rem', borderTop: '1px solid #e5e7eb', paddingTop: '1rem' },
  footerRow:    { display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  muted:        { fontSize: '.8rem', color: '#9ca3af' },
  errorText:    { color: '#b91c1c', fontSize: '.875rem', marginBottom: '.5rem' },
  btnRun:       { padding: '.45rem 1.1rem', background: '#2563eb', color: '#fff', border: 'none', borderRadius: 5, fontSize: '.875rem', fontWeight: 600, cursor: 'pointer' },
  btnDisabled:  { padding: '.45rem 1.1rem', background: '#d1d5db', color: '#9ca3af', border: 'none', borderRadius: 5, fontSize: '.875rem', fontWeight: 600, cursor: 'not-allowed' },
  btnSecondary: { marginTop: '1rem', padding: '.4rem .85rem', background: '#f3f4f6', border: '1px solid #d1d5db', borderRadius: 5, fontSize: '.875rem', cursor: 'pointer' },
}
