...
const styles: Record<string, React.CSSProperties> = {
  ...
  search:    { padding: '.3rem .6rem', border: '1px solid #e2e8f0', borderRadius: 4, fontSize: '.8rem', width: 160, background: '#fff' },
  ...
  th:        { textAlign: 'left', padding: '.5rem .6rem', background: '#f8fafc', borderBottom: '1px solid #e2e8f0', fontSize: '.6875rem', fontWeight: 700, color: '#64748b', textTransform: 'uppercase' as const, whiteSpace: 'nowrap' as const, letterSpacing: '.04em' },
  tr:        { borderBottom: '1px solid #f1f5f9' },
  editRow:   { borderBottom: '1px solid #e2e8f0', background: '#fffbeb' },
  td:        { padding: '.4rem .6rem', fontSize: '.8rem', verticalAlign: 'middle', color: '#1e293b' },
  tdNum:     { padding: '.4rem .6rem', fontSize: '.8rem', verticalAlign: 'middle', textAlign: 'right' as const, fontVariantNumeric: 'tabular-nums' as const, color: '#1e293b' },
