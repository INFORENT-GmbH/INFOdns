...
export const translations = {
  en: {
    ...
    dashboard_rendersQueued:  'Renders queued',
    dashboard_rendersIdle:    'idle',
    dashboard_bulkInFlight:   'Bulk jobs in flight',
    dashboard_mailFailed:     'Mail failures',
    dashboard_live:           'Live',
    dashboard_offline:        'Reconnecting…',
    dashboard_disconnected:   'Disconnected',
    dashboard_lastUpdated:    'Updated',
    dashboard_issues:         'Issues',
    dashboard_priorityUrgent: 'Urgent',
    dashboard_priorityHigh:   'High',
    dashboard_priorityNormal: 'Normal',
    dashboard_priorityLow:    'Low',
    dashboard_zoneOk:         'Zones OK',
    dashboard_byPriority:     'by priority',
    ...
    mailQueue_dismiss:        'Dismiss',
    mailQueue_dismissing:     'Dismissing…',
    mailQueue_dismissAll:     'Dismiss all failed',
    mailQueue_dismissAllConfirm: (n: number) =>
      `Dismiss all ${n} failed mail${n === 1 ? '' : 's'}? They will be marked as done without retrying.`,
    mailQueue_dismissed:      (n: number) => `${n} mail${n === 1 ? '' : 's'} dismissed`,
    mailQueue_page:        'Page',
    mailQueue_of:          'of',
    mailQueue_view:        'View',
    mailQueue_hide:        'Hide',
    ...
    ticketDetail_dragHint:    'drop or paste files',
    ticketDetail_quote:       'Quote',
    ticketDetail_quoteTitle:  'Quote this message in your reply',
    ticketDetail_onWrote:     (author: string, date: string) => `On ${date}, ${author} wrote:`,
    ticketDetail_event_statusChanged:   'changed status',
    ticketDetail_event_priorityChanged: 'changed priority',
    ticketDetail_event_assigneeChanged: 'reassigned',
    ticketDetail_event_none:            '—',
    tickets_needsReply:       'Needs reply',
    tickets_needsReplyHint:   'Show only open tickets where the requester sent the most recent message',
  ...
  de: {
    ...
    dashboard_pipeline:       'Pipeline',
    dashboard_rendersQueued:  'Render-Jobs in Warteschlange',
    dashboard_rendersIdle:    'leer',
    dashboard_bulkInFlight:   'Massenaufgaben aktiv',
    dashboard_mailFailed:     'Mail-Fehler',
    dashboard_live:           'Live',
    dashboard_offline:        'Verbinde neu…',
    dashboard_disconnected:   'Getrennt',
    dashboard_lastUpdated:    'Aktualisiert',
    dashboard_issues:         'Probleme',
    dashboard_priorityUrgent: 'Dringend',
    dashboard_priorityHigh:   'Hoch',
    dashboard_priorityNormal: 'Normal',
    dashboard_priorityLow:    'Niedrig',
    dashboard_zoneOk:         'Zonen OK',
    dashboard_byPriority:     'nach Priorität',
    dashboard_summary:        'Übersicht',
    ...
    mailQueue_dismiss:        'Quittieren',
    mailQueue_dismissing:     'Wird quittiert…',
    mailQueue_dismissAll:     'Alle fehlgeschlagenen quittieren',
    mailQueue_dismissAllConfirm: (n: number) =>
      `${n} fehlgeschlagene E-Mail${n === 1 ? '' : 's'} quittieren? Sie werden ohne erneutes Senden als erledigt markiert.`,
    mailQueue_dismissed:      (n: number) => `${n} E-Mail${n === 1 ? '' : 's'} quittiert`,
    ...
    ticketDetail_dragHint:    'Dateien einfügen oder ziehen',
    ticketDetail_quote:       'Zitieren',
    ticketDetail_quoteTitle:  'Diese Nachricht in der Antwort zitieren',
    ticketDetail_onWrote:     (author: string, date: string) => `Am ${date} schrieb ${author}:`,
    ticketDetail_event_statusChanged:   'änderte Status',
    ticketDetail_event_priorityChanged: 'änderte Priorität',
    ticketDetail_event_assigneeChanged: 'neu zugewiesen',
    ticketDetail_event_none:            '—',
    tickets_needsReply:       'Antwort fällig',
    tickets_needsReplyHint:   'Nur offene Tickets, bei denen die Anfragende Person zuletzt geschrieben hat',
