...
export const translations = {
  en: {
    ...
    domains_filteredCount:       (filtered: number, total: number) => `filtered ${filtered} of ${total}`,
  ...
  de: {
    ...
    domains_filteredCount:       (filtered: number, total: number) => `gefiltert ${filtered} von ${total}`,
