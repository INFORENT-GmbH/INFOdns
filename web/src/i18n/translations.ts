...
export const translations = {
  en: {
    ...
    users_firstName:   'First name(s)',
    users_lastName:    'Last name',
    users_addressHeading: 'Address',
    users_street:      'Street',
    users_zip:         'ZIP / Postal code',
    users_city:        'City',
    users_country:     'Country',
    users_contactHeading: 'Contact',
    users_phone:       'Phone',
    users_mobile:      'Mobile',
  ...
  de: {
    ...
    users_firstName:   'Vorname(n)',
    users_lastName:    'Nachname',
    users_addressHeading: 'Adresse',
    users_street:      'Straße',
    users_zip:         'PLZ',
    users_city:        'Ort',
    users_country:     'Land',
    users_contactHeading: 'Kontakt',
    users_phone:       'Telefon',
    users_mobile:      'Mobil',
